...
public class UserController {
    ...
    @GetMapping("/filterByInstitution/{institutionId}")
    public ResponseEntity<List<UserDto>> getFilteredUsersByInstitution(@PathVariable Long institutionId) {
        return ResponseEntity
                .ok()
                .body(userService.getFilteredUsersByInstitution(institutionId));
    }
}
